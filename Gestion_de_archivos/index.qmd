...
Si deseo indicar donde crear los archivos es necesario pasar como parámetro antes del nombre la ruta del directorio donde deseo crear este archivo.

```{pyhon}
"""
archivo = open("/home/statick/workspaces/Curso-de-Python-junio-2022/ejercicio2/nombres.txt","w")
print(archivo.read())
"""
```
...
Para crear archivos es necesario utilizar el comando mkdir.
